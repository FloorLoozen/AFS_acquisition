...
class MainWindow(QMainWindow):
    ...
    def _handle_start_recording(self, file_path):
        ...
        try:
            # ALWAYS use camera_widget.start_recording() for consistent behavior
            # This ensures camera settings are applied, buffers flushed, timers adjusted, etc.
